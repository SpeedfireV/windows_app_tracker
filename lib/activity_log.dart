...
class ActivityLog extends StatefulWidget {
  const ActivityLog({super.key, required this.apps});
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title: Text(
                                widget.apps.elementAt(index).appName,
                                style: TextStyle(
                                    color: AppColors.snowishColor,
                              ...
                              subtitle: Text(
                                widget.apps.elementAt(index).appTask,
                                style: TextStyle(
                                    color: AppColors.snowishColor,
                                    fontSize: 11,
                              ...
                              trailing: Text(
                                DateFormat('yyyy-MM-dd HH:mm:ss').format(
                                    widget.apps.elementAt(index).createdAt),
                                style: TextStyle(
                                    color: AppColors.snowishColor,
